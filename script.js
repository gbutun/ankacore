...
const translations = {
  en: {
    ...
    serviceSevenText: "Strengthen existing cloud environments through architecture optimization, cost control, performance tuning, security improvement, and operating model refinement.",
    ...
    serviceDetailSevenText: "Strengthen existing cloud environments by improving cost efficiency, architecture quality, security posture, performance, and operational fit. The goal is to help teams get more value from the platforms they already run.",
    serviceDetailSevenPointOne: "Architecture and platform optimization reviews",
    serviceDetailSevenPointTwo: "Cost, performance, and operational efficiency improvements",
    serviceDetailSevenPointThree: "Security, governance, and modernization recommendations for mature environments",
  ...
  tr: {
    ...
    serviceSevenText: "Mevcut bulut ortamlarını mimari optimizasyon, maliyet kontrolü, performans iyileştirmesi, güvenlik güçlendirmesi ve işletim modeli olgunlaştırmasıyla geliştirin.",
    ...
    serviceDetailSevenText: "Maliyet verimliliğini, mimari kaliteyi, güvenlik duruşunu, performansı ve operasyonel uyumu iyileştirerek mevcut bulut ortamlarını güçlendirin. Amaç, ekiplerin halihazırda işlettikleri platformlardan daha fazla değer elde etmesine yardımcı olmaktır.",
    serviceDetailSevenPointOne: "Mimari ve platform optimizasyon değerlendirmeleri",
    serviceDetailSevenPointTwo: "Maliyet, performans ve operasyonel verimlilik iyileştirmeleri",
    serviceDetailSevenPointThree: "Olgun ortamlarda güvenlik, yönetişim ve modernizasyon önerileri",
