...
const translations = {
  en: {
    ...
    blogPageText: "This page now acts as a curated showcase of selected Medium articles, helping visitors explore your thinking through topics like Azure networking, firewall design, secure infrastructure, and practical platform guidance.",
  ...
  tr: {
    ...
    blogPageText: "Bu sayfa artık seçilmiş Medium yazılarının küratörlü bir vitrini olarak çalışıyor; böylece ziyaretçiler Azure ağ yapıları, firewall tasarımı, güvenli altyapı ve pratik platform rehberliği gibi başlıklar üzerinden düşünce yapınızı inceleyebiliyor.",
