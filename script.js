...
const translations = {
  en: {
    ...
    blogEyebrow: "Blog",
    blogTitle: "Insights on cloud, security, Kubernetes, architecture, and transformation leadership.",
    blogIntro: "The blog now lives on a separate page, giving more room for insights, architecture notes, security perspectives, and transformation lessons that support the AnkaCore advisory brand.",
    blogPageCta: "Explore the Blog",
    blogPageEyebrow: "Blog",
    blogPageTitle: "Ideas, architecture patterns, and field insights from cloud, security, and platform transformation work.",
    blogPageText: "This page gives AnkaCore a place to publish practical thinking for enterprise leaders, architects, platform teams, and transformation stakeholders. It helps reinforce expertise before a conversation even starts.",
    blogOneTag: "Cloud Strategy",
    blogOneTitle: "Designing landing zones that support governance without slowing delivery",
    blogOneText: "A perspective on balancing control, security, and speed when shaping enterprise cloud foundations.",
    blogTwoTag: "Platform Engineering",
    blogTwoTitle: "What strong Kubernetes platforms actually give internal teams",
    blogTwoText: "A practical view of how platform standards, automation, and operating models reduce friction for delivery teams.",
    blogThreeTag: "Cyber Security",
    blogThreeTitle: "Why Zero-Trust needs architecture discipline, not only security tooling",
    blogThreeText: "A concise angle on making security part of architecture, delivery patterns, and governance from the start.",
    blogFourTag: "Transformation Leadership",
    blogFourTitle: "Why enterprise transformation succeeds when architecture and execution stay connected",
    blogFourText: "An executive view on reducing the gap between strategic intent, engineering reality, and measurable business outcomes.",
    blogCtaEyebrow: "Continue the Discussion",
    blogCtaTitle: "If a topic here reflects a challenge you are facing, that can be the starting point for a practical advisory conversation.",
    blogCtaText: "Cloud architecture, Kubernetes platforms, Zero-Trust, IaC, DevOps modernization, and AI-enabled delivery are all stronger when the discussion is grounded in real operating constraints and business goals.",
    blogCtaPrimary: "Book an Executive Consultation",
  ...
  tr: {
    ...
    blogEyebrow: "Blog",
    blogTitle: "Bulut, güvenlik, Kubernetes, mimari ve dönüşüm liderliği üzerine içgörüler.",
    blogIntro: "Blog artık ayrı bir sayfada yer alıyor; böylece AnkaCore danışmanlık markasını destekleyen içgörüler, mimari notlar, güvenlik bakış açıları ve dönüşüm dersleri için daha fazla alan oluşuyor.",
    blogPageCta: "Blogu İncele",
    blogPageEyebrow: "Blog",
    blogPageTitle: "Bulut, güvenlik ve platform dönüşüm çalışmalarından fikirler, mimari kalıplar ve saha içgörüleri.",
    blogPageText: "Bu sayfa, AnkaCore'a kurumsal liderler, mimarlar, platform ekipleri ve dönüşüm paydaşları için pratik düşünce liderliği yayınlayabileceği bir alan sunar. Böylece uzmanlık, görüşme başlamadan önce bile daha güçlü şekilde görünür hale gelir.",
    blogOneTag: "Bulut Stratejisi",
    blogOneTitle: "Teslimatı yavaşlatmadan yönetişimi destekleyen landing zone tasarımları",
    blogOneText: "Kurumsal bulut temellerini şekillendirirken kontrol, güvenlik ve hızın nasıl dengeleneceğine dair bir bakış.",
    blogTwoTag: "Platform Mühendisliği",
    blogTwoTitle: "Güçlü Kubernetes platformları iç ekipler için gerçekte ne sağlar",
    blogTwoText: "Platform standartları, otomasyon ve işletim modellerinin teslimat ekipleri üzerindeki sürtünmeyi nasıl azalttığına dair pratik bir değerlendirme.",
    blogThreeTag: "Siber Güvenlik",
    blogThreeTitle: "Zero-Trust neden yalnızca güvenlik araçları değil, mimari disiplini de gerektirir",
    blogThreeText: "Güvenliği en baştan mimari, teslimat kalıpları ve yönetişimin doğal bir parçası haline getirmeye dair kısa bir yaklaşım.",
    blogFourTag: "Dönüşüm Liderliği",
    blogFourTitle: "Kurumsal dönüşüm neden mimari ve uygulama bağlantıda kaldığında başarılı olur",
    blogFourText: "Stratejik niyet, mühendislik gerçekliği ve ölçülebilir iş çıktıları arasındaki boşluğu azaltmaya dair yönetici bakışı.",
    ...
    blogCtaPrimary: "Yönetici Danışmanlığı Planla",
