...
const translations = {
  en: {
    ...
    gridTwoValue: "Azure Infrastructure, AKS, OpenShift, Kubernetes, IaC, Zero-Trust",
    ...
    servicesTitle: "Focused services across cloud, platform engineering, reliability, migration, optimization, and high-trust delivery.",
    servicesIntro: "AnkaCore supports organizations that need practical progress across Azure, Kubernetes, security, observability, migration, optimization, and engineering delivery, especially where governance and risk must be handled correctly from the start.",
    ...
    serviceFiveTitle: "Site Reliability Engineering & Observability",
    serviceFiveText: "Improve service resilience with SRE practices, production readiness reviews, incident response patterns, and observability foundations that help teams detect and resolve issues faster.",
    serviceSixTitle: "Cloud Migration Services",
    serviceSixText: "Support cloud migration planning, landing readiness, workload prioritization, and execution guidance that reduces disruption while keeping security, governance, and operating fit in view.",
    serviceSevenTitle: "Cloud Optimization",
    serviceSevenText: "Strengthen existing cloud environments through Azure Well-Architected Framework reviews across reliability, security, cost optimization, operational excellence, and performance efficiency.",
    ...
    serviceDetailFiveKicker: "05",
    serviceDetailFiveTitle: "Site Reliability Engineering and Observability",
    serviceDetailFiveText: "Improve production resilience with SRE practices, service reliability guardrails, actionable telemetry, and operational patterns that help teams respond faster and learn from incidents more effectively.",
    serviceDetailFivePointOne: "SRE operating practices, service level objectives, and reliability reviews",
    serviceDetailFivePointTwo: "Observability strategy across logs, metrics, traces, and alerting",
    serviceDetailFivePointThree: "Incident readiness, post-incident learning, and production support improvements",
    serviceDetailSixKicker: "06",
    serviceDetailSixTitle: "Cloud Migration Services",
    serviceDetailSixText: "Plan and support cloud migration initiatives with a practical focus on readiness, sequencing, governance, and execution confidence. Engagements can help organizations move from legacy or on-premises environments without creating avoidable risk.",
    serviceDetailSixPointOne: "Migration readiness assessments and target-state planning",
    serviceDetailSixPointTwo: "Workload prioritization, landing preparation, and transition roadmaps",
    serviceDetailSixPointThree: "Execution guidance for secure, governed, and supportable migration programs",
    serviceDetailSevenKicker: "07",
    serviceDetailSevenTitle: "Cloud Optimization",
    serviceDetailSevenText: "Strengthen existing cloud environments through Azure Well-Architected Framework aligned reviews that help teams balance reliability, security, cost optimization, operational excellence, and performance efficiency against real business priorities.",
    serviceDetailSevenPointOne: "Well-Architected assessments and architecture reviews across the five pillars",
    serviceDetailSevenPointTwo: "Targeted recommendations for cost, performance, resilience, and operational maturity",
    serviceDetailSevenPointThree: "Security, governance, and modernization improvements shaped by WAF tradeoffs and priorities",
  ...
  tr: {
    ...
    gridTwoValue: "Azure Altyapısı, AKS, OpenShift, Kubernetes, IaC, Zero-Trust",
    ...
    servicesTitle: "Bulut, platform mühendisliği, güvenilirlik, geçiş, optimizasyon ve yüksek güvenli teslimat genelinde odaklı hizmetler.",
    servicesIntro: "AnkaCore; özellikle yönetişim ve riskin en baştan doğru ele alınması gereken ortamlarda Azure, Kubernetes, güvenlik, gözlemlenebilirlik, geçiş, optimizasyon ve mühendislik teslimatı konusunda kurumlara pratik ilerleme sağlar.",
    ...
    serviceFiveTitle: "Site Reliability Engineering ve Observability",
    serviceFiveText: "SRE pratikleri, üretime hazırlık değerlendirmeleri, olay müdahale kalıpları ve ekiplerin sorunları daha hızlı tespit edip çözmesini sağlayan gözlemlenebilirlik temelleriyle servis dayanıklılığını güçlendirin.",
    serviceSixTitle: "Bulut Geçiş Hizmetleri",
    serviceSixText: "Kesintiyi azaltırken güvenlik, yönetişim ve işletim uyumunu koruyan bulut geçiş planlaması, landing hazırlığı, iş yükü önceliklendirmesi ve uygulama rehberliği sağlayın.",
    serviceSevenTitle: "Bulut Optimizasyonu",
    serviceSevenText: "Mevcut bulut ortamlarını Azure Well-Architected Framework değerlendirmeleriyle; güvenilirlik, güvenlik, maliyet optimizasyonu, operasyonel mükemmeliyet ve performans verimliliği eksenlerinde güçlendirin.",
    ...
    serviceDetailFiveKicker: "05",
    serviceDetailFiveTitle: "Site Reliability Engineering ve Observability",
    serviceDetailFiveText: "SRE pratikleri, servis güvenilirliği guardrail'leri, eyleme dönük telemetry ve ekiplerin daha hızlı yanıt vermesine ve olaylardan daha güçlü öğrenmesine yardımcı olan operasyon kalıplarıyla üretim dayanıklılığını güçlendirin.",
    serviceDetailFivePointOne: "SRE çalışma pratikleri, servis seviyesi hedefleri ve güvenilirlik değerlendirmeleri",
    serviceDetailFivePointTwo: "Log, metric, trace ve alerting genelinde observability stratejisi",
    serviceDetailFivePointThree: "Olay hazırlığı, olay sonrası öğrenme ve üretim destek iyileştirmeleri",
    serviceDetailSixKicker: "06",
    serviceDetailSixTitle: "Bulut Geçiş Hizmetleri",
    serviceDetailSixText: "Hazırlık, sıralama, yönetişim ve uygulama güvenine odaklanan pratik bir yaklaşımla bulut geçiş girişimlerini planlayın ve destekleyin. Çalışmalar, kurumların legacy veya on-premises ortamlardan kaçınılabilir risk oluşturmadan ilerlemesine yardımcı olabilir.",
    serviceDetailSixPointOne: "Geçiş hazırlık değerlendirmeleri ve hedef durum planlaması",
    serviceDetailSixPointTwo: "İş yükü önceliklendirmesi, landing hazırlığı ve geçiş yol haritaları",
    serviceDetailSixPointThree: "Güvenli, yönetişim uyumlu ve desteklenebilir geçiş programları için uygulama rehberliği",
    serviceDetailSevenKicker: "07",
    serviceDetailSevenTitle: "Bulut Optimizasyonu",
    serviceDetailSevenText: "Mevcut bulut ortamlarını, Azure Well-Architected Framework ile uyumlu değerlendirmeler üzerinden güçlendirin; güvenilirlik, güvenlik, maliyet optimizasyonu, operasyonel mükemmeliyet ve performans verimliliğini iş öncelikleriyle dengeli şekilde ele alın.",
    serviceDetailSevenPointOne: "Beş sütun genelinde Well-Architected değerlendirmeleri ve mimari incelemeler",
    serviceDetailSevenPointTwo: "Maliyet, performans, dayanıklılık ve operasyonel olgunluk için hedefli öneriler",
    serviceDetailSevenPointThree: "WAF tradeoff'ları ve öncelikleriyle şekillenen güvenlik, yönetişim ve modernizasyon iyileştirmeleri",
